...
para_grid={'n_neighbors':list(range(1,30))}
grid_search1=GridSearchCV(knn,para_grid,cv=5)
...
print(knn_predict)
testing_data['PredictionChance']=knn_predict
testing_data.to_csv('PredictionsChance_knn.csv',index=False)